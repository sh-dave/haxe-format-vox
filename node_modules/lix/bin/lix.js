...
"DI3BfV/mmfQQnRVj5XUFw20N55EGIq3Pb67/UbzF5xE=":
function (require, module, exports, __dirname, __filename) {
...
lix_cli_Cli.dispatch = function(args) {
	var version = ({ scripts : { build : "haxe --run Build", noderify : "noderify", postinstall : "node bin/postinstall.js"}, repository : { url : "git+https://github.com/lix-pm/lix.git", type : "git"}, devDependencies : { noderify : "=3.0.2", tar : "=4.0.2", yauzl : "=2.6.0"}, files : ["bin"], bin : { haxelib : "bin/haxelibshim.js", lix : "bin/lix.js", neko : "bin/nekoshim.js", haxe : "bin/haxeshim.js"}, keywords : ["haxe"], version : "15.1.0-rc.2", author : "back2dos", description : "lix - Libraries for haXe", homepage : "https://github.com/lix-pm/lix#readme", license : "MIT", name : "lix", bugs : { url : "https://github.com/lix-pm/lix/issues"}}).version;
	...
	args = lix_cli_Command.expand(args,[lix_cli__$Command_CommandExpander_$Impl_$.ofString("+tink install github:haxetink/tink_${0}"),lix_cli__$Command_CommandExpander_$Impl_$.ofString("+coco install github:MVCoconut/coconut.${0}"),lix_cli__$Command_CommandExpander_$Impl_$.ofString("+lib install haxelib:${0}")]);
	...
	if(_g == -1) {
		...
		var v = _g;
		github = args.splice(v,2)[1];
	}
	var github1 = new lix_client_sources_GitHub(github);
	var _g1 = args.indexOf("--gl-private-token");
	var gitlab;
	if(_g1 == -1) {
		gitlab = null;
	} else {
		var v1 = _g1;
		gitlab = args.splice(v1,2)[1];
	}
	var gitlab1 = new lix_client_sources_GitLab(gitlab);
	var sources = [lix_client_sources_Web,lix_client_sources_Haxelib,github1,gitlab1,new lix_client_sources_Git(github1,gitlab1,scope)];
	var _g2 = new haxe_ds_StringMap();
	var _g3 = 0;
	while(_g3 < sources.length) {
		var s = sources[_g3];
		++_g3;
		var _g4 = 0;
		var _g5 = s.schemes();
	...
	var resolve = function(url) {
		var key = url.scheme;
		var _g31 = __map_reserved[key] != null ? resolvers.getReserved(key) : resolvers.h[key];
		if(_g31 == null) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Unknown scheme in url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Cli.hx", lineNumber : 47, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
			var v2 = _g31;
	...
	var libs = new lix_client_Libraries(scope,resolve,function(_1) {
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(501,"not implemented",{ fileName : "Cli.hx", lineNumber : 58, className : "lix.cli.Cli", methodName : "dispatch"})));
	},log,force,silent);
	lix_cli_Command.dispatch(args,"lix - Libraries for haXe (v" + version + ")",[new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("install"),"<url> [as <lib[#ver]>]","install lib from specified url",function(args1) {
		if(scope.isGlobal && !$global) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Current scope is global. Please use --global if you intend to install globally, or create a local scope with `lix scope create`.",{ fileName : "Cli.hx", lineNumber : 69, className : "lix.cli.Cli", methodName : "dispatch"})));
		} else {
			switch(args1.length) {
			case 0:
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Missing url",{ fileName : "Cli.hx", lineNumber : 82, className : "lix.cli.Cli", methodName : "dispatch"})));
			case 1:
				var library = args1[0];
				if(tink__$Url_Url_$Impl_$.parse(library).scheme == null) {
					return libs.install(library);
				} else {
					var url1 = args1[0];
					return libs.installUrl(tink__$Url_Url_$Impl_$.parse(url1));
				}
				break;
			case 2:
				if(args1[0] == "haxe") {
					var version1 = args1[1];
					return hx.install(version1,{ force : force});
				} else {
					var constraint = args1[1];
					var library1 = args1[0];
					var this1 = new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_semver__$Constraint_Constraint_$Impl_$.parse(constraint)));
					var f = $bind(libs,libs.install);
					var a1 = library1;
					return tink_core__$Promise_Promise_$Impl_$.next(this1,function(a2) {
						return f(a1,a2);
					});
				}
				break;
			case 3:
				if(args1[1] == "as") {
					var alias = args1[2];
					var url2 = args1[0];
					var this2 = tink__$Url_Url_$Impl_$.parse(url2);
					var this3 = lix_client_LibVersion.parse(alias);
					return libs.installUrl(this2,this3);
				} else {
					var v3 = args1;
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 83, className : "lix.cli.Cli", methodName : "dispatch"})));
				}
				break;
			default:
				var v4 = args1;
	...
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("install haxe"),"<version>|<alias>","install specified haxe version",null),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("use"),"haxe <alias>|<version>","use specified haxe version",function(args2) {
		if(args2.length == 2) {
			if(args2[0] == "haxe") {
				var version2 = args2[1];
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 89, className : "lix.cli.Cli", methodName : "dispatch"})));
			}
		} else {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid arguments",{ fileName : "Cli.hx", lineNumber : 89, className : "lix.cli.Cli", methodName : "dispatch"})));
		}
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("download haxe"),"<version>|<alias>","download specified haxe version",null),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("scope"),"[create|delete]","creates or deletes the current scope or\ninspects it if no argument is supplied",function(args3) {
		switch(args3.length) {
		case 0:
		...
		case 1:
			...
			case "delete":
				if(scope.isGlobal) {
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Cannot delete global scope",{ fileName : "Cli.hx", lineNumber : 103, className : "lix.cli.Cli", methodName : "dispatch"})));
				} else {
					scope["delete"]();
	...
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("haxe-versions"),"","lists currently downloaded versions",function(args4) {
		if(args4.length == 0) {
	...
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("download"),"[<url[#lib[#ver]]>]","download lib from url if specified,\notherwise download missing libs",function(args5) {
		switch(args5.length) {
		case 0:
			return tink_core__$Promise_Promise_$Impl_$.next(lix_client_haxe_Switcher.ensureNeko(Sys.println),function(_2) {
				var this4 = hx.resolveOnline(lix_client_haxe__$UserVersion_UserVersion_$Impl_$.ofString(scope.config.version));
				var f1 = $bind(hx,hx.download);
				return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(this4,function(a11) {
		...
		case 3:
			...
			case "as":
				...
				if(sys_FileSystem.exists(absTarget)) {
					...
					var v14 = "[WARN]: Processing obsolete `download " + args5.map(shorten).join(" ") + "`.\n        Please reinstall library in a timely manner!\n\n";
					process.stdout.write(Std.string(v14));
					process.stdout.write("\n");
					return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(libs.downloadUrl(tink__$Url_Url_$Impl_$.parse(url4),{ into : target}),function(a) {
			...
			case "into":
				var dir = args5[2];
				var url5 = args5[0];
				return tink_core__$Promise_Promise_$Impl_$.noise(libs.downloadUrl(tink__$Url_Url_$Impl_$.parse(url5),{ into : dir}));
			default:
				var v15 = args5;
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"too many arguments",{ fileName : "Cli.hx", lineNumber : 198, className : "lix.cli.Cli", methodName : "dispatch"})));
			}
	...
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run"),"lib ...args","run a library",function(args6) {
		if(args6.length == 0) {
			...
			var args7 = args6;
			return tink_core__$Promise_Promise_$Impl_$.noise(tink_core__$Promise_Promise_$Impl_$.next(scope.getLibCommand(args7),function(cmd) {
				return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(cmd()));
			}));
		}
	}),new lix_cli_Command(["--version","-v"],"","print version",function(args8) {
		if(args8.length > 0) {
	...
	}),new lix_cli_Command(lix_cli__$Command_CommandName_$Impl_$.ofString("run-haxelib"),"path ...args","invoke a haxelib at a given path following haxelib's conventions",function(args9) {
		if(args9.length == 0) {
			...
			new haxeshim_HaxelibCli(scope).run(args9.slice(1));
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
		}
...
var lix_client_ArchiveInfos = function(name,version,classPath,runAs,postDownload,postInstall) {
	this.name = name;
	this.version = version;
...
lix_client_DownloadedArchive.readInfos = function(root,lib) {
	...
	if(files.indexOf("haxelib.json") != -1) {
		...
		return new lix_client_ArchiveInfos(_g3,_g2,_g1,files.indexOf("run.n") != -1 || info.mainClass != null ? "haxelib run-dir " + info.name + " $" + "{DOWNLOAD_LOCATION}" : null,info.postDownload,info.postInstall);
	} else if(files.indexOf("package.json") != -1) {
		var info1 = JSON.parse(js_node_Fs.readFileSync("" + root + "/package.json",{ encoding : "utf8"}));
		var _g11 = info1.name;
		var _g4 = info1.version;
		return new lix_client_ArchiveInfos(_g11,_g4,guessClassPath(),null,null,null);
	} else {
		var o = lib.name;
		var _g12;
		if(o[1] == 0) {
		...
		var o1 = lib.version;
		var l = new tink_core__$Lazy_LazyConst("0.0.0");
		var _g5;
		if(o1[1] == 0) {
			var v2 = o1[2];
			_g5 = v2;
		...
		return new lix_client_ArchiveInfos(_g12,_g5,guessClassPath(),null,null,null);
	}
};
...
lix_client_Download.unzip = function(src,into,peel,res,events) {
	tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.buffered(res),function(bytes) {
		return tink_core__$Future_Future_$Impl_$.async(function(cb) {
			lix_client_uncompress_Yauzl.fromBuffer(new js_node_buffer_Buffer(bytes.b.bufferValue),function(err,zip) {
				var saved = -1;
				var done = function() {
					saved += 1;
				...
				if(err != null) {
					var this1 = tink_core_Outcome.Failure(new tink_core_TypedError(422,"Failed to unzip " + src,{ fileName : "Download.hx", lineNumber : 65, className : "lix.client.Download", methodName : "unzip"}));
					cb(this1);
				}
...
lix_client_Download.untar = function(src,into,peel,res,events) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
								...
								js_node_Fs.unlink(link1[0].to,(function(link2) {
									return function(_) {
										js_node_Fs.symlink(link2[0].from,link2[0].to,(function() {
											return function(e) {
												var this1 = e == null ? tink_core_Outcome.Success(tink_core_Noise.Noise) : tink_core_Outcome.Failure(new tink_core_TypedError(null,e.message,{ fileName : "Download.hx", lineNumber : 112, className : "lix.client.Download", methodName : "untar"}));
												cb1(this1);
											};
										})());
									};
		...
		var fail = function(message) {
			error = new tink_core_TypedError(null,message,{ fileName : "Download.hx", lineNumber : 124, className : "lix.client.Download", methodName : "untar"});
...
lix_client_Download.download = function(url,handler) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		...
		var fail = function(e) {
			var fail1 = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to download " + url + " because " + e.message,e,{ fileName : "Download.hx", lineNumber : 266, className : "lix.client.Download", methodName : "download"}));
			cb(fail1);
		};
		...
		req.on("response",function(res) {
			if(res.statusCode >= 400) {
				var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(res.statusCode,res.statusMessage,res,{ fileName : "Download.hx", lineNumber : 277, className : "lix.client.Download", methodName : "download"}));
				cb(tmp);
			} else {
...
lix_client_Libraries.prototype = {
	...
	,downloadArchive: function(a,__tink_tmp7) {
		var _gthis = this;
		if(__tink_tmp7 == null) {
			__tink_tmp7 = { };
		}
		var into = __tink_tmp7.into == null ? null : __tink_tmp7.into;
	...
	,installArchive: function(a,$as,withHaxeLibDependencies) {
		...
		return tink_core__$Promise_Promise_$Impl_$.next(this.downloadArchive(a),function(a1) {
			...
			if(name == null) {
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Could not determine library name for " + tink__$Url_Url_$Impl_$.toString(a1.job.normalized),{ fileName : "Libraries.hx", lineNumber : 102, className : "lix.client.Libraries", methodName : "installArchive"})));
			}
			...
			var haxelibs = null;
			var deps;
			var _g1 = "" + haxe_io_Path.removeTrailingSlashes("" + a1.storageRoot + "/" + a1.relRoot) + "/haxelib.json";
			var found1 = _g1;
			if(sys_FileSystem.exists(found1)) {
				haxelibs = JSON.parse(js_node_Fs.readFileSync(found1,{ encoding : "utf8"})).dependencies;
				var __tmp = [];
				var _g11 = 0;
				var _g2 = Reflect.fields(haxelibs);
				while(_g11 < _g2.length) {
					var name1 = _g2[_g11];
					++_g11;
					__tmp.push("-lib " + name1);
				}
				deps = __tmp;
			} else {
				deps = [];
			...
			var interpolate = function(s) {
				return haxeshim_Resolver.interpolate(s,function(__tink_tmp0) {
					if(__tink_tmp0 == "DOWNLOAD_LOCATION") {
						return "$" + "{HAXESHIM_LIBCACHE}/" + a1.relRoot;
					} else {
						return null;
					}
				});
			...
			var lines = [];
			var _g21 = infos.runAs;
			if(_g21 != null) {
				var v2 = _g21;
				lines.push("# @run: " + interpolate(v2));
			}
			var _g3 = infos.postDownload;
			if(_g3 != null) {
				var v3 = _g3;
				lines.push("# @post-install: " + interpolate(v3));
			}
			js_node_Fs.writeFileSync(hxml,lines.concat(["# @install: lix --silent download \"" + tink__$Url_Url_$Impl_$.toString(a1.job.normalized) + "\" into " + a1.relRoot,"-D " + name + "=" + version,"-cp $" + "{HAXESHIM_LIBCACHE}/" + a1.relRoot + "/" + infos.classPath,extra]).concat(deps).join("\n"));
			var exec = function(hook,cmd) {
				if(cmd != null) {
					cmd = _gthis.scope.interpolate(interpolate(cmd));
					_gthis.log("Processing " + hook + " hook:");
					_gthis.log("> " + cmd);
					return new tink_core__$Future_SyncFuture(new tink_core__$Lazy_LazyConst(tink_core_OutcomeTools.map(haxeshim_Exec.shell(cmd,_gthis.scope.cwd,_gthis.scope.haxeInstallation.env()),function(_) {
			...
			return tink_core__$Promise_Promise_$Impl_$.next(tink_core__$Promise_Promise_$Impl_$.next(haxelibs == null ? tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise)) : lix_client_sources_Haxelib.installDependencies(haxelibs,_gthis,function(s1) {
				return sys_FileSystem.exists("" + _gthis.scope.scopeLibDir + "/" + s1 + ".hxml");
			}),function(_1) {
				if(!a1.alreadyDownloaded) {
					return exec("post download",infos.postDownload);
				} else {
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success(tink_core_Noise.Noise));
				}
			}),function(_2) {
...
lix_client_haxe_Switcher.prototype = {
	officialInstalled: function(kind) {
		...
		while(_g1 < _g2.length) {
			var v = _g2[_g1];
			++_g1;
			if(!lix_client_haxe__$UserVersion_UserVersion_$Impl_$.isHash(v) && js_node_Fs.statSync(this.versionDir(v)).isDirectory()) {
				_g.push(v);
			}
		}
	...
	,resolve: function(version,getOfficial,getNightlies) {
		...
		case 3:
			...
			return tink_core__$Promise_Promise_$Impl_$.ofSpecific(tink_core__$Promise_Promise_$Impl_$.next(getNightlies(),function(v) {
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Unknown nightly " + lix_client_haxe__$UserVersion_UserVersion_$Impl_$.toString(version),{ fileName : "Switcher.hx", lineNumber : 163, className : "lix.client.haxe.Switcher", methodName : "resolve"})));
			}));
		case 4:
			...
			return tink_core__$Promise_Promise_$Impl_$.ofSpecific(tink_core__$Promise_Promise_$Impl_$.next(getOfficial(lix_client_haxe_PickOfficial.IncludePrereleases),function(versions) {
				if(Lambda.has(versions,version1)) {
					...
					return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(404,"Unknown version " + version1,{ fileName : "Switcher.hx", lineNumber : 171, className : "lix.client.haxe.Switcher", methodName : "resolve"})));
				}
			}));
		case 5:
			var path = version[2];
	...
	,processUrl: function(url) {
		...
		if(StringTools.startsWith(gh,"https://github.com")) {
			...
			if(StringTools.endsWith(v,".git")) {
				tmp1 = tink__$Url_Url_$Impl_$.parse(HxOverrides.substr(v,0,v.length - 4));
			} else {
				var v1 = _g1;
				tmp1 = tink__$Url_Url_$Impl_$.parse(v1);
			}
			...
			if(StringTools.startsWith(gl,"https://gitlab.com")) {
				...
				if(StringTools.endsWith(v2,".git")) {
					tmp3 = tink__$Url_Url_$Impl_$.parse(HxOverrides.substr(v2,0,v2.length - 4));
				} else {
					var v3 = _g2;
					tmp3 = tink__$Url_Url_$Impl_$.parse(v3);
				}
				return tmp2.processUrl(tmp3);
			} else {
				var _hx_tmp = tink__$Url_Url_$Impl_$.parse(_g);
				var url1 = _hx_tmp;
				var origin = tink__$Url_Url_$Impl_$.resolve(url1,tink__$Url_Url_$Impl_$.parse(""));
				var version;
				var _g3 = url1.hash;
				if(_g3 == null) {
					version = "HEAD";
				...
				return tink_core__$Promise_Promise_$Impl_$.next(sha,tink_core__$Promise_Next_$Impl_$.ofSafeSync(function(sha1) {
					var tmp4 = tink__$Url_Url_$Impl_$.resolve(url1,tink__$Url_Url_$Impl_$.parse("#" + sha1));
					...
					return { url : url1, normalized : tmp4, dest : tmp5, lib : tmp6, kind : tmp7};
				}));
			}
		}
	}
...
lix_client_sources_GitHub.prototype = {
	...
	,grabCommit: function(owner,project,version) {
		return tink_core__$Promise_Promise_$Impl_$.next(lix_client_Download.text("https://" + this.credentials + "api.github.com/repos/" + owner + "/" + project + "/commits?sha=" + version),function(s) {
			try {
				...
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"Failed to lookup sha for github:" + owner + "/" + project + s1,{ fileName : "GitHub.hx", lineNumber : 27, className : "lix.client.sources.GitHub", methodName : "grabCommit"})));
			}
		});
	}
		...
		if(commitish == null) {
			...
			if(sha.length == 40) {
				var d = lix_client_ArchiveDestination.Computed(function(l) {
					return [l.name,l.version,"github",sha];
				});
				return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success({ normalized : tink__$Url_Url_$Impl_$.parse("https://" + this.credentials + "github.com/" + owner + "/" + project + "/archive/" + sha + ".tar.gz"), dest : d, url : tink__$Url_Url_$Impl_$.parse("https://" + this.credentials + "github.com/" + owner + "/" + project + "/archive/" + sha + ".tar.gz"), lib : new lix_client_LibVersion(haxe_ds_Option.Some(project),haxe_ds_Option.None)}));
			} else {
				var v = commitish;
				...
				return tink_core__$Promise_Promise_$Impl_$.next(this.grabCommit(owner,project,v),tmp1);
			}
		}
	}
	,processUrl: function(url) {
		...
		var _hx_tmp;
		if(_g == null) {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid github url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "GitHub.hx", lineNumber : 48, className : "lix.client.sources.GitHub", methodName : "processUrl"})));
		} else {
			_hx_tmp = tink_url__$Path_Path_$Impl_$.parts(_g);
			if(_hx_tmp.length == 2) {
				var project = _hx_tmp[1];
				var owner = _hx_tmp[0];
				return this.getArchive(tink_url__$Portion_Portion_$Impl_$.stringly(owner),tink_url__$Portion_Portion_$Impl_$.stringly(project),url.hash);
			} else {
	...
	,processUrl: function(url) {
		...
		if(_g == null) {
			...
			if(_hx_tmp.length == 2) {
				var project = _hx_tmp[1];
				var owner = _hx_tmp[0];
				return this.getArchive(tink_url__$Portion_Portion_$Impl_$.stringly(owner),tink_url__$Portion_Portion_$Impl_$.stringly(project),url.hash,{ host : url.host});
			} else {
...
lix_client_sources_Haxelib.schemes = function() {
	return ["haxelib"];
};
lix_client_sources_Haxelib.processUrl = function(url) {
	...
	var _hx_tmp;
	if(_g == null) {
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid haxelib url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Haxelib.hx", lineNumber : 12, className : "lix.client.sources.Haxelib", methodName : "processUrl"})));
	} else {
		_hx_tmp = tink_url__$Path_Path_$Impl_$.parts(_g);
		if(_hx_tmp.length == 1) {
			var v = _hx_tmp[0];
			return lix_client_sources_Haxelib.getArchive(tink_url__$Portion_Portion_$Impl_$.stringly(v),url.hash,{ host : url.host});
		} else {
			return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Failure(new tink_core_TypedError(null,"invalid haxelib url " + tink__$Url_Url_$Impl_$.toString(url),{ fileName : "Haxelib.hx", lineNumber : 14, className : "lix.client.sources.Haxelib", methodName : "processUrl"})));
		}
	}
};
lix_client_sources_Haxelib.getArchive = function(name,version,options) {
	if(version == null) {
		var a1 = name;
		var a3 = options;
		var tmp = function(a2) {
			return lix_client_sources_Haxelib.getArchive(a1,a2,a3);
		};
		return tink_core__$Promise_Promise_$Impl_$.next(lix_client_sources_Haxelib.resolveVersion(name,options),tmp);
	} else {
		var v = version;
		return tink_core__$Promise_Promise_$Impl_$.ofOutcome(tink_core_Outcome.Success({ url : tink__$Url_Url_$Impl_$.parse("https://" + lix_client_sources_Haxelib.HOST + "/p/" + name + "/" + version + "/download/"), normalized : options != null && options.host != null ? tink__$Url_Url_$Impl_$.parse("haxelib://" + options.host + "/" + name + "#" + version) : tink__$Url_Url_$Impl_$.parse("haxelib:" + name + "#" + version), dest : lix_client_ArchiveDestination.Fixed([name,version,"haxelib"]), kind : lix_client_ArchiveKind.Zip, lib : new lix_client_LibVersion(haxe_ds_Option.Some(name),haxe_ds_Option.Some(version))}));
	}
};
lix_client_sources_Haxelib.getHost = function(options) {
	if(options == null) {
		return lix_client_sources_Haxelib.HOST;
	} else if(options.host == null) {
		return lix_client_sources_Haxelib.HOST;
	} else {
		var v = options.host;
...
lix_client_sources_Haxelib.resolveVersion = function(name,options) {
	return tink_core__$Future_Future_$Impl_$.async(function(cb) {
		var cnx = haxe_remoting_HttpAsyncConnection.urlConnect("https://" + lix_client_sources_Haxelib.getHost(options) + "/api/3.0/index.n");
		cnx.setErrorHandler(function(e) {
			var tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to get version information from haxelib because " + e,e,{ fileName : "Haxelib.hx", lineNumber : 43, className : "lix.client.sources.Haxelib", methodName : "resolveVersion"}));
			cb(tmp);
		});
...
lix_client_sources_Haxelib.installDependencies = function(haxelibs,libs,skip) {
	var _g = [];
	var _g1 = 0;
	var _g2 = Reflect.fields(haxelibs);
	while(_g1 < _g2.length) {
		var name = [_g2[_g1]];
		++_g1;
		_g.push(tink_core__$Future_Future_$Impl_$.async((function(name1) {
			return function(cb) {
				if(skip(name1[0])) {
					cb(tink_core_Outcome.Success(tink_core_Noise.Noise));
					return;
				}
				var version = tink__$Url_Url_$Impl_$.parse(haxelibs[name1[0]]);
				libs.log("Installing dependency " + name1[0]);
				var this1;
				var _g3 = version.scheme;
				if(_g3 == null) {
					var name2 = name1[0];
					var _g31 = version.payload;
					var this2;
					switch(_g31) {
					case "":case "*":
						this2 = null;
					...
					var this3 = lix_client_sources_Haxelib.getArchive(name2,this2);
					this1 = libs.installArchive(this3,null,true);
				} else {
					var v1 = _g3;
					this1 = libs.installUrl(version,new lix_client_LibVersion(haxe_ds_Option.Some(name1[0]),haxe_ds_Option.None));
				}
				this1.handle((function(name3) {
					return function(o) {
						var tmp;
						if(o[1] == 1) {
							var e = o[2];
							tmp = tink_core_Outcome.Failure(tink_core_TypedError.withData(e.code,"" + name3[0] + ": " + e.message,e.data,{ fileName : "Haxelib.hx", lineNumber : 68, className : "lix.client.sources.Haxelib", methodName : "installDependencies"}));
						} else {
							tmp = o;
						}
						cb(tmp);
	...
	var ret = _g;
	var ret1 = tink_core__$Future_Future_$Impl_$.ofMany(ret).map(function(results) {
		var errors = [];
		var _g11 = 0;
		...
		if(errors.length == 0) {
			...
			var v2 = errors;
			return tink_core_Outcome.Failure(tink_core_TypedError.withData(null,"Failed to install dependencies:\n  " + errors.map(function(e2) {
				return e2.message;
			}).join("\n  "),errors,{ fileName : "Haxelib.hx", lineNumber : 88, className : "lix.client.sources.Haxelib", methodName : "installDependencies"}));
		}
	});
	return ret1.gather();
};
...
lix_client_sources_Web.processUrl = function(url) {
	...
	if(lib != null) {
		url = tink__$Url_Url_$Impl_$.parse(tink__$Url_Url_$Impl_$.toString(url).split("#")[0]);
	}
	var d = lix_client_ArchiveDestination.Computed(function(l) {
...
lix_client_sources_Haxelib.HOST = "lib.haxe.org";
...
"SX9P+POf3/GXLCE0cLDxEkkQ4tPflmjCjO2alrFH938=":
function (require, module, exports, __dirname, __filename) {
'use strict'
...
"WNb8RC4Ezo6409lmaxJKMwXTIqWNjWO558pNF+EKhg8=":
function (require, module, exports, __dirname, __filename) {
